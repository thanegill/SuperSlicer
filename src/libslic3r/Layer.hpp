...
//fake layer that can be inside a shared_ptr (public destructor) for tilted bed.
class StubLayer : public SupportLayer {
public:
    StubLayer(Layer* layer, size_t interface_id, double dz, PrintObject* object);
    bool is_support() const { return m_interface_id != 0; }
    virtual ~StubLayer();
};
